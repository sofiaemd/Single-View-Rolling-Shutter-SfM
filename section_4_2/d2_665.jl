...
@var vx,vy,vz, wx,wy,wz, a1,b1,c1,d1, a2,b2,c2,d2, a3,b3,c3
d3 = 1
@var x1a,y1a,x1b,y1b,x1c,y1c,x1d,y1d,x1e,y1e,x1f,y1f,x2a,y2a,x2b,y2b,x2c,y2c,x2d,y2d,x2e,y2e,x2f,y2f,x3a,y3a,x3b,y3b,x3c,y3c,x3d,y3d,x3e,y3e

variables = [vx,vy,vz, wx,wy,wz, a1,b1,c1,d1, a2,b2,c2,d2, a3,b3,c3]
parameters = [x1a,y1a,x1b,y1b,x1c,y1c,x1d,y1d,x1e,y1e,x1f,y1f,x2a,y2a,x2b,y2b,x2c,y2c,x2d,y2d,x2e,y2e,x2f,y2f,x3a,y3a,x3b,y3b,x3c,y3c,x3d,y3d,x3e,y3e]
...
eqn2f = u2f * Ld2x * (L2 - y2f*V - y2f^2*W)
...
eqns = [eqn1a;eqn1b;eqn1c;eqn1d;eqn1e;eqn1f;eqn2a;eqn2b;eqn2c;eqn2d;eqn2e;eqn2f;eqn3a;eqn3b;eqn3c;eqn3d;eqn3e]
